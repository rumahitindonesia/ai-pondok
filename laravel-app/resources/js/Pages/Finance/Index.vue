    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-3xl font-black tracking-tight text-[#161514] dark:text-[#f2e8d5]">
                Manajemen <span class="text-[#d02e5c]">Keuangan</span>
            </h2>
        </template>
        ...
        <div class="space-y-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Total Billed -->
                <div class="bg-white dark:bg-[#161514] p-10 rounded-[32px] border border-[#ebeae8] dark:border-[#3e3c3a] shadow-sm relative overflow-hidden group hover:border-[#d02e5c] transition-all">
                    <div class="absolute -right-4 -top-4 w-24 h-24 bg-[#d02e5c]/5 rounded-full blur-2xl group-hover:bg-[#d02e5c]/10 transition-all"></div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <Link :href="route('finance.billings')" class="flex items-center gap-6 p-8 bg-[#161514] text-white rounded-[40px] shadow-2xl hover:bg-black transition-all group">
                    <div class="w-16 h-16 bg-[#d02e5c] rounded-2xl flex items-center justify-center shadow-lg group-hover:rotate-6 transition-transform">
                ...
                <Link :href="route('finance.payments')" class="flex items-center gap-6 p-8 bg-white dark:bg-[#161514] rounded-[40px] border border-[#ebeae8] dark:border-[#3e3c3a] shadow-sm transition-all group hover:border-[#d02e5c]">
                    <div class="w-16 h-16 bg-[#f5f4f2] dark:bg-[#262524] rounded-2xl flex items-center justify-center text-[#d02e5c] group-hover:scale-110 transition-transform">
                ...
                <Link :href="route('finance.settings')" class="flex items-center gap-6 p-8 bg-white dark:bg-[#161514] rounded-[40px] border border-[#ebeae8] dark:border-[#3e3c3a] shadow-sm transition-all group hover:border-[#d02e5c]">
                    <div class="w-16 h-16 bg-[#f5f4f2] dark:bg-[#262524] rounded-2xl flex items-center justify-center text-[#d02e5c] group-hover:rotate-90 transition-transform duration-500">
