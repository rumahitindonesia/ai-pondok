...
class AbsensiController extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = Santri::whereIn('status', ['Santri Aktif', 'Santri Magang', 'Alumni Aktif - dipondok']);
        ...
        $availableKelas = Santri::whereIn('status', ['Santri Aktif', 'Santri Magang', 'Alumni Aktif - dipondok'])->whereNotNull('kelas')->distinct()->pluck('kelas')->sort();
        $availableKamar = Santri::whereIn('status', ['Santri Aktif', 'Santri Magang', 'Alumni Aktif - dipondok'])->whereNotNull('kamar')->distinct()->pluck('kamar')->sort();
